...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <header class="flex items-center justify-between px-8 py-4">
            <a href="#">
                <img class="h-12" src="{{ asset('img/logo.svg') }}" alt="logo">
            </a>
            ...
            <div class="w-70 mr-5">
                <div
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input class="w-full text-sm bg-gray-100 border-none rounded-xl
                                          placeholder-gray-900 px-4 py-2" type="text" placeholder="Your Idea">
                        </div>
                        <div>
                            <select class="w-full text-sm bg-gray-100 rounded-xl px-4 py-2 border-none"
                        ...
                        <div>
                            <textarea class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 px-4 py-2
                                             border-none" name="idea" id="idea" cols="30" rows="4"
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button
                                class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue font-semibold
                                       rounded-xl border border-blue hover:bg-blue-hover transition duration-150
                                       ease-in px-6 py-3 text-white"
                                type="submit">
                                <span>Submit</span>
                            </button>
                        </div>
